...
////////////////////////////////////////////////////////////////////////////////
//
// GetPreferences 함수의 전역선언 declare global GetPreferences function
...
////////////////////////////////////////////////////////////////////////////////
// 
// SetThreadName 함수의 전역선언 declare global SetThreadName function
...
// 64bit 단일명령(원자적) 비교와 교환 지원을 위한 전역함수, 아마도 인텔과 AMD
// 제품에서만 작동할 것이다, 그리고 비스타와 그이상 만 지원하는
// InterlockedCompareExchange64 함수를 제고하는 윈도우 API이기 때문에 다른것은
// 필요없다, 그리고 VC++ 2005 컴파일러 고유의 _InterlockedCompareExchange64 에
// 접근할 수 없기 때문이다.
//
